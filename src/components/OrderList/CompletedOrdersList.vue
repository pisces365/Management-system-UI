  ...
  <div>
    <md-table v-model="searched" :table-header-color="tableHeaderColor"  md-sort="delivery_id" md-sort-order="asc" md-fixed-header>
      ...
      <md-table-row slot="md-table-row" slot-scope="{ item }">
        ...
        <md-table-cell md-label="详细信息"><md-button class="md-raised md-primary" data-background-color="green" @click="getDetails3">查看</md-button></md-table-cell>
      </md-table-row>
    </md-table>
  </div>
</template>
      ...
      orders: [
        {
          order_id: "#Ord000011",
          delivery_id: "#00004",
          order_status: "已完成于2021-11-29",
        },
        {
          order_id: "#Ord000022",
          delivery_id: "#00005",
          order_status: "已完成于2021-11-28",
        },
        {
          order_id: "#Ord000033",
          delivery_id: "#00006",
          order_status: "已完成于2021-11-20",
        },
      ],
    };
  },
